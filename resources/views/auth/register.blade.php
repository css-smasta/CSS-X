            ...
            <div class="row justify-content-center">
              <div class="col-12 col-md-5 col-xl-4 my-5">
                ...
                <p class="text-muted text-center mb-5">
                  Halo anggota CSS baru! Segera daftar untuk memulai.
                </p>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <!-- Input -->
                        <input placeholder="Masukkan Absenmu!" id="css_number" type="text" class="form-control{{ $errors->has('css_number') ? ' is-invalid' : '' }}" name="class_number" value="{{ old('css_number') }}" required>
